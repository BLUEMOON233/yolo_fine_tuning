...
bool Detector::postprocess_cpu() {
    ...
    */
    ...
    m_outputPath = changePath(m_imagePath, "../../../results", ".png", tag);
    ...
    for (int i = 0; i < final_bboxes.size(); i ++){
        ...
        auto name = labels.pascal_get_label(box.label);
        auto rec_color = labels.pascal_get_color(box.label);
